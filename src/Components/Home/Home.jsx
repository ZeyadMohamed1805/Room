...
const Home = () => {
    ...
    return (
        <section className="col-span-2 row-span-1 bg-cover bg-center bg-no-repeat relative max-lg:min-h-[15rem] w-full" style={{backgroundImage: `url(${imageURL})`}}>
            <div className="absolute bottom-0 -right-1/4 flex w-1/4 max-lg:right-0">
